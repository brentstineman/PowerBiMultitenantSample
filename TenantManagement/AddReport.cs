...
namespace TenantManagement
{
    ...
    public static class AddReport
    {
        ...
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = "{workspaceid}/Reports")]HttpRequestMessage req, string workspaceId, TraceWriter log)
        {
